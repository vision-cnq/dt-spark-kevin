 ...
 * @author kevin
 * @version 1.0
 * @description     取两个RDD之间的交集
 * @createDate 2018/12/30
 */
public class Intersection_RDD {

    public static void main(String[] args) {

        // 1.创建SparkConf，设置作业名称和模式
        SparkConf conf = new SparkConf().setAppName("Intersection_RDD").setMaster("local");
        ...
        intersection.foreach(new VoidFunction<String>() {
            ...
            public void call(String s) throws Exception {
                System.out.println("去两个rdd的交集"+s);
            }
        });
